...
This package follows the [`pacs008`](https://github.com/sebastienrousseau/pacs008)
...
| :--- | :--- | :--- |
| `0.0.12` (latest) | Current | ✅ Yes |

## Reporting a vulnerability

**Do not open a public issue for security reports.** Use GitHub
Private Vulnerability Reporting:
<https://github.com/sebastienrousseau/pacs008-loader-mt103/security/advisories/new>
...
This package exposes one function, `parse_mt103(text)`, that converts
a SWIFT MT103 text payload into pacs.008 flat records. It does **not**
parse XML, write files, or make network calls. Untrusted input is
regex-bounded to a small set of expected MT103 field shapes; anything
...
| :--- | :--- |
| **XML / XXE / billion-laughs** | Out of scope. MT103 is a flat text format with no XML envelope. |
...
| **Dependency CVEs** | `pacs008 >= 0.0.7, < 1` is the only runtime dependency. |

### Cryptography status

This package implements **no** cryptographic functionality. MT103
